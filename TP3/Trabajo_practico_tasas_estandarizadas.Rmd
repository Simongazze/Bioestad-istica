...
niveles_edad <- c("0-4", "5-9", "10-14", "15-19", "20-24",
...
tasas_filtrado <- tasas_etar %>%
  mutate(Grupo_etario = factor(Grupo_etario, levels = niveles_edad),
         tasa_masc = round(tasa_masc, 2),
...
Los resultados de las tasas estandarizadas fueron los siguientes:
